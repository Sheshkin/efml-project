...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels=3, base_filters=64, bilinear=True):
        super().__init__()
        f = base_filters
...
def build_unet(base_filters=64, bilinear=True):
    return UNet(in_channels=3, base_filters=base_filters, bilinear=bilinear)
