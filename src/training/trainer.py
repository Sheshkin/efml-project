...
class Trainer:
    def __init__(self, model, train_loader, val_loader, device, lr=1e-4, weight_decay=1e-5, checkpoint_dir="results/checkpoints", log_dir="results/logs", experiment_name="finetune"):
    ...
    def validate(self):
        ...
        return {
            ...
            "val_iou": total_iou / max(1, total_samples),
            "val_pixel_acc": total_acc / max(1, total_samples),
        }
